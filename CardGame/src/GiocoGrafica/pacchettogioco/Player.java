...
public class Player {
    ...
    public void turno(Deck deck, Deck oggetti, AutoPlayer p) throws IOException{
                    ...
                    if(oggettiInMano.size()==1){
                        ...
                        while(bandierina==0){
                            ...
                            if(choice2>=oggettiInMano.size()||choice2<0){
                                System.out.println("\n Hai scelto una carta non disponibile! Riprova! ");
                            }
                            else{
                        ...
                        System.out.println("\n Non hai nessuna carta da utilizzare! \n");
                    }
                    break;
                default:
        ...
        while(flagp==0){
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.println("\n Inserisci il numero della carta che vuoi usare (da 0 al numero massimo) : ");
                            int choice2= input.readInt();
